...
![login](/img/guide/loki/connexion.png)

## Premiers pas

Pour explorer vos logs de façon ponctuel, sélectionner **Explore** dans le menu de gauche, puis **Loki** dans la liste déroulante

![explore](/img/guide/loki/explore.png)
...
![premierspas](/img/guide/loki/premierspas.png)
...
![premierspas_contains](/img/guide/loki/premierspas_contains.png)
...
![dashboard](/img/guide/loki/dashboard.png)
...
`| pattern '<ip> - <user> <_>'`: applique un patter sur la ligne de log, pour ne garder que l'ip et l'utilisateur (_ permet de dire que le champ n'est pas intéressant)
`| keep user`: permet de garder que le label **user**
