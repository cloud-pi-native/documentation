...
| `/console/readonly` (groupe d'identité Vault `console-readonly`)     | `platform--readonly`           | **Lecture plateforme non-sensible** : `sys/health`, `sys/mounts`, `sys/auth`, `sys/policies`. Pas `<name>/data/*`.                                                                                                                                    |
...
| `/<slug>/console/readonly`                                         | `project--<name>--readonly`    | **List strict projet** : `<name>/data/*` {list}. Rien d'autre.                                                                                                                                                                                        |
